...
file_path = '../Generated_Signal_Data_with_Noise.csv'  # Путь к вашему файлу
data = load_data(file_path)

# Частота дискретизации
fs = 1.0  # Предполагаемая частота дискретизации в Гц

# Параметры фильтра на основе спектра (подавление частоты 0.02 Гц)
notch_freq = 0.2 # Частота подавления в Гц
Q = 0.1  # Попробуем уменьшить качество фильтра для более широкой полосы подавления
